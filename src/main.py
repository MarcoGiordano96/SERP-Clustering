...
def main():
    ...
    parser.add_argument('--url_column', type=str, default='result.organic_results.link',
                        help="Name of the column containing URLs in the input CSV. Default is 'result.organic_results.link' for DataForSEO.")
